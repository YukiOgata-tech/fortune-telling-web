        ...
        <div className="flex items-start gap-1 md:gap-4 mb-2">
          ...
          <div className="space-y-2">
            <h2 className="md:text-2xl text-lg font-extrabold tracking-tight text-white drop-shadow">
              <span className="md:text-3xl text-2xl text-yellow-200">生涯年収</span>を診断しよう
            </h2>
        ...
        <div className="flex justify-center">
          <Link to="/fortune-wealth" className="w-full md:w-auto relative z-10">
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-6 py-1.5 md:py-3 rounded-xl bg-gradient-to-r from-yellow-400 via-yellow-300 to-amber-500 text-yellow-900 font-semibold shadow-md"
              onClick={() => {
