...
const faqData = [
  { question: "このサイトの占いは無料ですか？", answer: "はい、全ての占い・診断コンテンツは無料でご利用いただけます。ぜひ毎日利用して運気を挙げていきましょう！" },
  { question: "アカウント登録すると何ができますか？", answer: "基本的な機能は登録不要で使えますが、過去の診断の記録やランキング・コメント参加機能にはアカウント登録が必要です。さらにメールの定期配信が受け取れます。無料でメニュー欄から登録しちゃいましょう！" },
  { question: "診断や占い結果は全て真実ですか？", answer: "結論から言うと結果がすべて正しいわけではありません。統計的な観点などから導出しているにすぎません。この世に100%あたる占いなどありません。でもなにかを信じていなきゃ人生やっていけません。まずはあなたの身近にいる人から信じてみましょう、全部さらけ出すんです！！" },
  { question: "診断結果はどのように保存されますか？", answer: "ログインユーザーはダッシュボードから一部過去の診断履歴を確認できます。未登録の場合は保存されません。なにか機能追加の希望があればお問い合わせからご連絡ください♪" },
...
function FaqItem({ question, answer, isOpen, onClick }) {
  ...
  // answerがReact要素の場合は、plainTextだけ入れる
  const faqJsonLd = {
  ...
  return (
    <div className="mb-4">
       {/* ★ ここでJSON-LDをheadへ挿入（React19ならreturnの最初でOK） */}
